...
export aur_packagelist="koreader-bin ncurses5-compat-libs lib32-ncurses5-compat-libs meowsans-ttf frogmouth goldendict-ng qalculate-gtk-git kew lutgen-bin gowall paleta tcolors"
